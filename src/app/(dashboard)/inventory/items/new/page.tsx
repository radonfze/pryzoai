import { db } from "@/db";
import { itemCategories, itemBrands, itemModels, itemSubcategories, brandSubcategories } from "@/db/schema";
...
export default async function NewItemPage() {
    ...
    const [categoryList, subCategoryList, brandList, modelList, uomList, brandMapping] = await Promise.all([
