...
function POActionsCell({ order, userId }: { order: PurchaseOrder; userId: string }) {
  ...
  const handleCancel = async (reason: string) => {
    ...
    console.log("Cancelling PO:", order.id, "Reason:", reason)
...
export function createColumns(userId: string): ColumnDef<PurchaseOrder>[] {
  return [
    {
    ...
    {
      id: "actions",
      cell: ({ row }) => <POActionsCell order={row.original} userId={userId} />,
    },
  ]
}

// Legacy export for backward compatibility
export const columns: ColumnDef<PurchaseOrder>[] = createColumns("")
