...
export function PrintInvoiceClient({ invoice }: PrintInvoiceClientProps) {
         ...
         <div className="flex justify-between mb-12">
            <div>
               ...
               {invoice.customer.trn && (
                 <p className="text-gray-600 mt-1">TRN: {invoice.customer.trn}</p>
               )}
            </div>
            <div className="text-right">
               <div className="mb-2">
                  <span className="text-gray-500">Invoice Date:</span>
                  <span className="font-bold ml-4">{invoice.date}</span>
               </div>
               <div>
                  <span className="text-gray-500">Due Date:</span>
                  <span className="font-bold ml-4">{invoice.dueDate}</span>
               </div>
            </div>
         </div>
