...
export function QuotationForm({ customers, items, initialData }: QuotationFormProps) {
  ...
  useEffect(() => {
    const reserveNumber = async () => {
      if (initialData) {
        setReservedNumber(initialData.quotationNumber || "");
  ...
  const onSubmit = async (data: QuotationFormValues) => {
    ...
    try {
      ...
      if (result && result.success) {
        ...
        setSavedQuoteNumber(result.data?.quotationNumber || reservedNumber);
    ...
    <>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader className="text-center">
            ...
            <DialogTitle className="text-xl">
                {documentType === "proforma" ? "Proforma " : "Quotation "} Created!
            </DialogTitle>
            <DialogDescription className="text-base">
              Document <span className="font-semibold text-foreground">{savedQuoteNumber}</span> has been created successfully.
            </DialogDescription>
          </DialogHeader>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit, onInvalid)} className="space-y-6">
           ...
           <div className="rounded-xl bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 p-6 text-white shadow-lg">
                ...
                <div>
                  <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-2xl font-bold">
                      {initialData ? "Edit " : "New "}{documentType === "proforma" ? "Proforma Invoice" : "Quotation"}
                    </h1>
                  </div>
                  {numberLoading ? (
                ...
                <CardContent className="pt-4 pb-3">
                  <div className="grid grid-cols-5 gap-3 mb-3">
                     <div>
                      ...
                      <div className="h-9 px-3 py-2 rounded-md bg-orange-50 dark:bg-orange-900/30 text-sm font-bold text-orange-700">
            ...
            <div className="space-y-4">
               <Card>
                 ...
                 <CardContent className="space-y-4">
                    ...
                    <Button type="submit" className="w-full mt-4 bg-gradient-to-r from-orange-500 to-amber-600" disabled={loading}>
