...
const footerLinks = {
  ...
  Resources: ["Help Center", "Guides", "Webinars", "Templates", "Community"],
    ...
    <footer className="bg-foreground text-background py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-8 lg:mb-0">
            ...
            <p className="text-sm text-background/70 max-w-xs">
              Modern accounting software for growing businesses. Financial clarity made simple.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-background/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-background/60">© 2026 Pryzo. All rights reserved.</p>
